  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.infoText}>
        <p>
          Go back to choose another protein sequence or continue to find the
          most likely transcription factor binding sites for the chosen protein
          and the selected genome.
        </p>
      </div>
    </div>
  );
